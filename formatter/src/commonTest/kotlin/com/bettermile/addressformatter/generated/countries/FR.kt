...
public class FR {
  ...
  public fun Toulouse() {
    ...
    val components = mapOf("city" to "Toulouse", "country" to "France", "country_code" to "FR",
  ...
  public fun remove_postcode_range() {
    ...
    val components = mapOf("city" to "Mulhouse", "country" to "France", "country_code" to "fr",
  ...
  public fun House_in_Cayenne_4_93802_52_32985() {
    ...
    val components = mapOf("country" to "France", "country_code" to "fr", "county" to "Cayenne",
  ...
  public fun road_48_406168_2_55452() {
    ...
    val components = mapOf("country" to "France", "country_code" to "fr",
  ...
  public fun `43_42981_6_77514`() {
    ...
    val components = mapOf("amenity" to "A1X4E0", "country" to "France", "country_code" to "fr",
  ...
  public fun `48_8564_2_2961`() {
    ...
    val components = mapOf("city" to "Paris 7e Arrondissement", "country" to "France",
  ...
  public fun `45_08523_5_73302`() {
    ...
    val components = mapOf("country" to "France", "country_code" to "fr", "county" to "Isère",
        "house_number" to "83", "municipality" to "Grenoble",
        "neighbourhood" to "Lotissement des cartonneries", "postcode" to "38560",
        "road" to "Avenue Jean Navarre", "state" to "Auvergne-Rhône-Alpes", "state_code" to "ARA",
        "village" to "Champ-sur-Drac")
    val expected = """
  ...
  public fun `7_06073496297967_6_60534772183623`() {
    ...
    val components = mapOf("country" to "France", "country_code" to "fr", "county" to "Doubs",
  ...
  public fun `48_80868_7_78761`() {
    ...
    val components = mapOf("country" to "France", "country_code" to "fr", "county" to "Bas-Rhin",
        "municipality" to "Haguenau-Wissembourg", "postcode" to "67500",
        "region" to "Metropolitan France", "road" to "Rue des Voituriers", "state" to "Grand Est",
        "state_code" to "GES", "town" to "Haguenau")
    val expected = """
        |Rue des Voituriers
        |67500 Haguenau
        |France
